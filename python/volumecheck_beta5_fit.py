...
def main():
    ...
    for case in CASES:
        ...
        # Cornell-type fit on main range R=1..4
    ...
    plt.xlabel("R")
    plt.ylabel("V(R)")
    plt.title(r"Finite-volume check at $\beta=5.0$")
    plt.legend()
    plt.tight_layout()
    plt.savefig(runs_dir / "beta5_volumecheck_V_of_R.png", dpi=150)

    with open(runs_dir / "beta5_volumecheck_fit_summary.csv", "w", newline="") as f:
        writer = csv.writer(f)
        writer.writerow([
    ...
    print("\n=== BETA=5.0 VOLUME CHECK FIT SUMMARY ===")
    ...
    print("\nSaved:")
    print(runs_dir / "beta5_volumecheck_V_of_R.png")
    print(runs_dir / "beta5_volumecheck_fit_summary.csv")
